...
Revision ID: ae421c5771d7
Revises: 
Create Date: 2026-03-17 18:15:37.523388
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'user_task', 'user', ['user_id'], ['id'], ondelete='CASCADE')
